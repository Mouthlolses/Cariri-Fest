...
import caririfest.composeapp.generated.resources.icon_ticket
import caririfest.composeapp.generated.resources.tickets
...
fun Tag(
    ...
    painter: Painter = painterResource(Res.drawable.tickets)
) {
    Row(
        modifier = modifier
            .background(
